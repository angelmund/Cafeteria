 ...
 * @author algel
 */
public class JFrameMenuPrueba extends javax.swing.JFrame {

    Conexion mConexion;
    Array mListaProductos;
    Array mListaTamanos;
     ...
     */
    public JFrameMenuPrueba() {
        initComponents();
        //mConexion = new Conexion("cafeteria","root", ""); //conexion a la bd
    ...
    public void llenarProductos()
    {
        if(mConexion.conectar()){
            ...
            mListaProductos = mConexion.getListaProductos();
        }
    } */
 ...
 /*
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 230, 370, 170));
    ...
    Conexion conexion = new Conexion("cafeteria", "root", "");
    conexion.conectar();
    
    
    try {
        
        Connection mConexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/cafeteria?useSSL=false&useTimezone=true&serverTimezone=UTC&allowPublicKeyRetrieval=true", "root", "");
        ...
        if (FilaSeleccionada >= 0) {
            ...
            Datos[2] = tab_Productos.getValueAt(FilaSeleccionada, 2).toString();
            Datos[3] = tab_Productos.getValueAt(FilaSeleccionada, 3).toString();
            Datos[4] = tab_Productos.getValueAt(FilaSeleccionada, 4).toString();
        ...
        for (int i = 0; i < tab_Productos.getRowCount(); i++) {
            ...
            Datos[4] = tab_Productos.getValueAt(i, 4).toString();
        ...
        for(int i = 0; i <tab_Productos.getRowCount();i++)
        {        
            PreparedStatement pst = mConexion.prepareStatement(
                "INSERT INTO venta(idventa,productos,tamanos,cantidad,precio,total) VALUES(?,?,?,?,?,?)");
            pst.setString(1, tab_Productos.getValueAt(i, 0).toString());
            pst.setString(2, tab_Productos.getValueAt(i, 1).toString());
            pst.setString(3, tab_Productos.getValueAt(i, 2).toString());
            pst.setString(4, tab_Productos.getValueAt(i, 3).toString());
            pst.setString(5, tab_Productos.getValueAt(i, 4).toString());
            pst.setString(6, tab_Productos.getValueAt(i, 5).toString());
            pst.executeUpdate();            
        }
    } catch (SQLException e) {
        System.out.println("Error al realizar pedido: " + e);
    } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameMenuPrueba.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameMenuPrueba().setVisible(true);
            }
        });
    }
